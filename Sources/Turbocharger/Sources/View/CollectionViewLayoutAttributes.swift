...
public struct AnyCollectionViewLayoutAttributes: CollectionViewLayoutAttributes {
    ...
    @inlinable
    public init<Attributes: CollectionViewLayoutAttributes>(_ attributes: Attributes) {
    ...
    public static func == (lhs: AnyCollectionViewLayoutAttributes, rhs: AnyCollectionViewLayoutAttributes) -> Bool {
...
class AnyCollectionViewLayoutAttributesStorageBase: @unchecked Sendable {
    ...
    func isEqual(to other: AnyCollectionViewLayoutAttributesStorageBase) -> Bool {
        fatalError("base")
    }
}
...
>: AnyCollectionViewLayoutAttributesStorageBase, @unchecked Sendable {
    ...
    @usableFromInline
    init(_ layoutAttributes: Attributes) {
    ...
    override func isEqual(to other: AnyCollectionViewLayoutAttributesStorageBase) -> Bool {
        guard let other = other as? AnyCollectionViewLayoutAttributesStorage<Attributes> else {
            return false
        }
